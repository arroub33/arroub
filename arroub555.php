...
<html>
<head>
<title>SmailMax SMTP Mailer</title>
...
<br /><br />
<div align="center" class="style2">SmailMax SMTP Mailer</div>
<br /><br />
  </div>
   <div id="result">
...
<p class="footer" onclick="javascript:DoS()"><blink> ©<?php echo date("Y",time())." SmailMax"; ?></blink></p>
<script>function DoS() { document.location.replace("mailto:ur0@hotmail.com");} </script>
